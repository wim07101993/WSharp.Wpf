...
namespace WSharp.Wpf
{
    ...
    {
        /// <summary>Queues a notification message for display in a snackbar.</summary>
        ...
        ///     Subsequent, duplicate messages queued within a short time span will be discarded. To
        ///     override this behaviour and ensure the message always gets displayed set to <c>true</c>.
        /// </param>
