...
namespace WSharp.Wpf.Transitions
{
    public class FadeWipe : ITransitionWipe
    {
        ...
        public void Wipe(TransitionerSlide fromSlide, TransitionerSlide toSlide, Point origin, IZIndexController zIndexController)
        {
            ...
            _ = fromAnimation.KeyFrames.Add(new LinearDoubleKeyFrame(1, zeroKeyTime));
            _ = fromAnimation.KeyFrames.Add(new EasingDoubleKeyFrame(0, endKeyTime, _sineEase));

            // To
            var toAnimation = new DoubleAnimationUsingKeyFrames();
            _ = toAnimation.KeyFrames.Add(new LinearDoubleKeyFrame(0, zeroKeyTime));
            _ = toAnimation.KeyFrames.Add(new EasingDoubleKeyFrame(1, endKeyTime, _sineEase));
