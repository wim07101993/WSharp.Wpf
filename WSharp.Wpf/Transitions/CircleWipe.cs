...
namespace WSharp.Wpf.Transitions
{
    public class CircleWipe : ITransitionWipe
    {
        public void Wipe(TransitionerSlide fromSlide, TransitionerSlide toSlide, Point origin, IZIndexController zIndexController)
        {
            ...
            _ = opacityAnimation.KeyFrames.Add(new EasingDoubleKeyFrame(1, midKeyTime));
            ...
            _ = scaleAnimation.KeyFrames.Add(new EasingDoubleKeyFrame(0, zeroKeyTime));
            _ = scaleAnimation.KeyFrames.Add(new EasingDoubleKeyFrame(1, endKeyTime));
