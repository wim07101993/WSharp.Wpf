...
namespace WSharp.Wpf
{
    internal class SnackbarMessageQueueItem
    {
        ...
        /// <summary>The content to be displayed</summary>
        public object Content { get; }

        /// <summary>Message show duration.</summary>
        public TimeSpan Duration { get; }

        /// <summary>The content for the action button on the snackbar</summary>
        public object ActionContent { get; }

        /// <summary>Handler to be invoked when the action button is clicked</summary>
        public Action<object> ActionHandler { get; }

        /// <summary>The argument to pass to the <see cref="ActionHandler"/> delegate.</summary>
        ...
        /// <summary>Still display this message even if it is a duplicate.</summary>
