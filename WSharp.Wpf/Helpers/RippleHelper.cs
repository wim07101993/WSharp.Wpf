...
namespace WSharp.Wpf.Helpers
{
    public static class RippleHelper
    {
        ...
        /// <summary>
        ///     Set to <c>true</c> to cause the ripple to originate from the centre of the content.
        ///     Otherwise the effect will originate from the mouse down position.
        /// </summary>
        ...
        /// <summary>Set to <c>True</c> to disable ripple effect</summary>
