...
namespace WSharp.Wpf.Converters
{
    public class BorderClipConverter : IMultiValueConverter
    {
        ...
        private static Geometry GetRoundRectangle(Rect baseRect, Thickness borderThickness, CornerRadius cornerRadius)
        {
            ...
            // Adjust the width of the TopLeft and TopRight rectangles so that they are proportional
            // to the width of the baseRect
            ...
            // Adjust the height of the TopRight and BottomRight rectangles so that they are
            // proportional to the height of the baseRect
            ...
            // Adjust the width of the BottomLeft and BottomRight rectangles so that they are
            // proportional to the width of the baseRect
            ...
            // Adjust the height of the TopLeft and BottomLeft rectangles so that they are
            // proportional to the height of the baseRect
